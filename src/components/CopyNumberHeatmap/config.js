 ...
 */
const curr_width = 1100
const curr_height = 539
const COMPONENTS = {
  width: curr_width,
  height: curr_height,

  legendWidth: .25* curr_width,
  legendX: 0,
  miniMapWidth: .10 * curr_width,
  minimapHeight: 0.75 * curr_height,

  heatmapChromHeight: .025 * curr_height
};
...
const HEATMAP_CONSTANTS = {
  ...
  legend: {
    ...
    squareSpacing: 5,
    textOffset: 5,
    titleWidth: .10 * curr_width,
    titleHeight: 15
  },
  
  categories: {
    legendWidth: .30 * curr_width,
    legendHeight: 55,
