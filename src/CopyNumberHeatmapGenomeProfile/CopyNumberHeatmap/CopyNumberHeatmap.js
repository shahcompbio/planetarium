...
const CopyNumberHeatmap = ({width,height,setHoverCellCoordinate, analysis, allHeatmapOrder, categoryStats, chromosomes, segs,analysisStats }) => {
  ...
  const yScale = getYScale(
    ...
    useEffect(() =>{
      setHoverCellCoordinate(hoverCell)
    },[hoverCell])
